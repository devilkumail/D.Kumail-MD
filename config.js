...
const baseConfig = {
  ...
  BOT_INFO: process.env.BOT_INFO || "D.Kumail MD;D.Kumail;default",
  RBG_KEY: process.env.RBG_KEY || "",
  ALLOWED: process.env.ALLOWED || "91,94,2",
  NOT_ALLOWED: process.env.NOT_ALLOWED || "852",
  CHATBOT: process.env.CHATBOT || "off",
  HANDLERS: process.env.HANDLERS || ".,",
  STICKER_DATA: process.env.STICKER_DATA || "D.Kumail MD",
  BOT_NAME: process.env.BOT_NAME || "D.Kumail MD",
  AUDIO_DATA:
  ...
  LANGUAGE: process.env.LANGUAGE || "urdu",
  AUTO_UPDATE: convertToBool(process.env.AUTO_UPDATE) || true,
  SUPPORT_GROUP: process.env.SUPPORT_GROUP || "https://t.me/dkumail_md",
